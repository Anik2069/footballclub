 ...
 * @author C Bazaar
 */
public class upcomingstriker extends upcommingplayers {
   private double passacuray;

    public upcomingstriker(double passacuray, String name, String previousclub, int goalno, double sellmoney) {

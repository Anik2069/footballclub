 ...
 * @author C Bazaar
 */
public class defender extends players implements contractPaper {

    private int pass;

    public defender(String name, int age, String contractNumber, int jerseyNumber, double salary, int goal, int assist, int totalMatch, double fitness, int contractDuration, int pass) {
